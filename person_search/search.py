    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
                ...
                for *xyxy, conf, cls in reversed(det):
                    if names[int(cls)] == 'person':
                        ...
                        if w * h > 50:
                            ...
                            crop_img = im0[ymin:ymax, xmin:xmax]  # HWC (602, 233, 3)  这个im0是读取的帧，获取该帧中框的位置 im0= <class 'numpy.ndarray'>
            ...
            if webcam:
                ...
                cv2.waitKey(25)
            if save_res:
                if isinstance(vid_cap, cv2.VideoCapture) or isinstance(dataset, LoadStreams):
